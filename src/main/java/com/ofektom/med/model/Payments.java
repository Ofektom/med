...
public class Payments {
    ...
    public Payments(Long id, String billNumber, String invoiceNumber, User patient, User doctor, RoomAllotment roomAllotment, LocalDate invoiceDate, LocalDate dueDate, LocalDate paymentDate, String paymentMethod, PaymentStatus paymentStatus, Double subTotalAmount, Double tax, Double discount, Double totalAmount, String notes, String termsAndConditions, List<PaymentItem> paymentItems, LocalDateTime createdAt, LocalDateTime updatedAt) {
        this.id = id;
